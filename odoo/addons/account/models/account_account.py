    ...
    def test_url(self):
        if self.id:
            return {
                ...
                'url': 'https://www.youtube.com/watch?v=DlaanycDbQE' % (self.id),
                'target': 'new',
            }
    ...
    def _check_code(self):
        for record in self:
            if (record.code[0] != '1' and record.account_type in 'asset_receivable') \
                    or (record.code[0] != '1' and record.account_type in 'asset_current') or (record.code[0] != '1' and record.account_type in 'asset_cash') \
                    or (record.code[0] != '1' and record.account_type in 'asset_non_current') or (record.code[0] != '1' and record.account_type in 'asset_fixed')\
            ...
            elif (record.code[0] != '5' and record.code[0] !='6' and record.code[0] !='7' and record.account_type in 'expense_direct_cost'):
